...
FunctionsToExport = @('Export-EvergreenFunctionStrings', 
               ...
               'Get-MicrosoftWvdRtcService', 'Get-MozillaFirefox', 'Get-mRemoteNG', 
               ...
               'Get-VMwareTools', 'Get-WinMerge', 'Get-WinSCP', 'Get-WixToolset', 
               'Get-Zoom')
